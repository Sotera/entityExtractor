...
class SimilarityCluster:
    def __init__(self, similarity_threshold, initial_vector_id,
        initial_post_id, initial_vector, start_time_ms,
    ...
    def process_similarity(self, vector_id, post_id, vector,
        vector_normalized, image_url=None):
    ...
    def apply_vector_to_average(self, vector):
        ...
        self.normalized_average_similarity_vector = np.linalg.norm(
            self.average_similarity_vector)
